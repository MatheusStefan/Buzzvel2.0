...
const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <header className="font-roboto z-20 flex flex-row md:flex-col items-start w-full mt-2 md:mt-6 lg:mt-4 px-6">
      <div className="flex items-center justify-between w-full">
        <nav>
          <ul className="flex md:gap-[12px] lg:gap-[24px] items-center">
            <p id="home" className="font-bold text-[32px] flex dark:text-white">
              soller
            </p>
            <li className="hidden md:block pt-2 hover:text-mid-yellow font-medium transition-all duration-300 dark:text-gray-300">
              <a
                href="#products"
        ...
        <div className="hidden md:flex lg:flex-row items-center md:gap-1 lg:gap-4 xl:gap-10">
          <div className="flex p-1 md:pb-2.5 md:flex-col items-center text-center group">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
              ...
              className="flex transition-all duration-300 group-hover:fill-purple"
            >
              <path
            ...
            <a
              ...
              className={`text-${
                darkMode ? "white" : "light-blue"
              }md:text-xs lg:text-lg hover:text-mid-yellow transition-all duration-300 font-bold`}
            >
              555 818 282
            </a>
          </div>
