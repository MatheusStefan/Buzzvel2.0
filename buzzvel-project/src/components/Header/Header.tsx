  ...
  return (
    <div className="font-roboto z-20 flex flex-row items-center justify-between md:justify-around w-full md:m-4">
      <ul className="flex md:gap-[12px] lg:gap-[24px] items-center ml-4">
        ...
        <li className="hidden md:block pt-2 hover:text-dark-yellow font-medium">
        ...
        <div className="flex p-1 md:pb-2.5 md:flex-col items-start md:items-center w-fit group">
          ...
          >
            <path
              ...
              fill="#0369A1"
              className="transition-all duration-300 group-hover:fill-dark-yellow"
            />
          </svg>

          <a
            href="tel:+555 818 282"
            className="text-light-blue md:text-xs lg:text-lg hover:text-dark-yellow transition-all duration-300 font-bold"
          >
            555 818 282
          </a>
        </div>
